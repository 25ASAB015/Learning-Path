# 🚀 Mi Journey de Aprendizaje Tecnológico
...
<details>
<summary><strong>🏆 2025 (0 cursos completados a partir del 06 sep 2025)</strong></summary>

| 🎓 Curso | 🏫 Plataforma | 📅 Completado | ⏱️ Duración | ⭐ Rating | 📁 Proyecto |
|----------|-------------|-------------|-----------|---------|------------|
| **** | **** | **** | ****- | ⭐⭐⭐⭐⭐ | []() |
...
<!-- Contador de visitas dinámico usando shields.io y GitHub profile views -->
